...
export default class VidioItem extends React.Component{
    render(){
            ...
            <View style={styles.container}>
                ...
                <View style={styles.descContainer}>
                    ...
                    <View style={styles.vidioDetails}>
                        <Text numberOfLines={2} style={styles.vidioTitle}>{vidio.snippet.title}</Text>
                        <Text style={styles.vidioStats}>{vidio.snippet.channelTitle + " · "+ nFormatter(vidio.statistics.viewCount,1) + ' 3 months ago'}</Text>
                    </View>
                    <TouchableOpacity>
